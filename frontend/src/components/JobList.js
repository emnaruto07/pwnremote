...
function JobListItem({job}){
  ...
  return(  
    <NavLink to={`/jobs/${job.id}`}>
      <div {...condition ? 'true': "false" } style={{ backgroundColor: condition ? "#FAF884" : "white" }} className="border-solid border-2 border-gray-200 px-2 py-3 shadow-lg rounded-2xl mb-3">
